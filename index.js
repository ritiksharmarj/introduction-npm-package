...
function logDetails() {
  const message = "Hey there! I'm Ritik, a fullstack freelance developer.";
  const twitterLink = 'https://twitter.com/ritiksharmarj';
  const linkedinLink = 'https://www.linkedin.com/in/ritiksharmarj/';
  const githubLink = 'https://github.com/ritiksharmarj';
